...
function initAvatar() {
  ...
  const coreVert = /* glsl */`
    ...
    void main() {
      ...
      // 多频动态形变：让球面像有机生物一样起伏
      float warp =
          sin(dir.x * 2.8 + uTime * 0.31) * cos(dir.z * 2.3 + uTime * 0.19) * 0.035
        + sin(dir.y * 3.5 - uTime * 0.24) * cos(dir.x * 2.1 + uTime * 0.28) * 0.020
        + sin(dir.z * 5.2 + dir.y * 3.8 + uTime * 0.17) * 0.010;
